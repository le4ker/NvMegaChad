...
map("n", "<leader>Y", "<cmd>%y+<CR>", { desc = "General Copy whole file" })
...
map("n", "<leader>v", "<cmd> vsplit <CR>", { desc = "General  Verticalsplit" })
...
map("n", "<leader>dov", "<cmd> DapStepOver <CR>", { desc = "DAP Step over" })
...
map("n", "<leader>dou", "<cmd> DapStepOut <CR>", { desc = "DAP Step out" })
